...
#define IRW_VERSION "IRW 0xB4DC0D3 1.0-20050222"
...
void ClientPrint(char *Text, ...);
void ClientPrintWarning(char *Text, ...);
void ClientPrintColor(unsigned short Color, unsigned short Font, char *Text, ...);
void ClientPrintAbove(unsigned int Serial, char *Text, ...);
...
void SetLastTile(unsigned short X, unsigned short Y, unsigned short Z);
...
unsigned short GetLastTileZ(void);
...
void TargetReplyTile(unsigned short Graphic, unsigned short X, unsigned short Y, unsigned short Z, int Sequence);
...
void AddTab(HWND TabWnd, char *Name, int Resizeable);
...
int AddCommand(char *Name, void *Handler);
